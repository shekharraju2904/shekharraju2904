...
const VerifierDashboard: React.FC<VerifierDashboardProps> = ({ currentUser, expenses, categories, projects, sites, companies, onUpdateExpenseStatus, onBulkUpdateExpenseStatus, onToggleExpensePriority, onViewExpense }) => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-neutral-50">Verification Queue</h2>
        <p className="mt-1 text-neutral-400">Review and verify the following expense requests.</p>
      </div>
      ...
      <div className="p-6 bg-neutral-900/50 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <div>
            <label htmlFor="sort-by-verifier" className={formLabelStyle}>Sort By</label>
            <select 
              id="sort-by-verifier" 
              name="sort"
              value={sortBy} 
